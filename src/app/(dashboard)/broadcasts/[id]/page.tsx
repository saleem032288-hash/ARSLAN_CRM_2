...
export default function BroadcastDetailPage() {
  ...
  const mode = extractSendingMode(broadcast.audience_filter);
  const isSuperSafe = mode === 'super_safe';
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <div className="flex items-center gap-3">
              ...
              {isSuperSafe && (
                <span className="inline-flex items-center rounded-full border border-teal-500/30 bg-teal-500/10 px-2 py-0.5 text-xs font-medium text-teal-400">
                  {t('modeSuperSafe')}
                </span>
              )}
            </div>
